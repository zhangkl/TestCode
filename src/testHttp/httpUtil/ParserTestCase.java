...
public class ParserTestCase extends TestCase {
    ...
    public void testTable() {
        ...
        OrFilter lastFilter = new OrFilter(tableFilter,tableFilter);
        try {
            nodeList = myParser.extractAllNodesThatMatch(lastFilter);
            for (int i = 0; i <= nodeList.size(); i++) {
     ...
     */
     public void testDivCSS() {
         try {
             ...
             OrFilter lastFilter = new OrFilter(textFilter,textFilter);
